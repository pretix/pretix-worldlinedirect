...
logger = logging.getLogger("pretix_payonedirect")


class PayOneDirectSettingsHolder(WorldlineDirectSettingsHolder):
    identifier = "payonedirect_settings"
    verbose_name = _("PayOne Direct")
    is_enabled = False
    is_meta = True


class WorldlineDirectMethod(SuperWorldlineDirectMethod):
    identifier = "payonedirect"
